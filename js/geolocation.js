...
export const handleWeatherByGeolocation = () => {
	...
	const success = async (pos) => {
		...
		const response = await fetch(`https://api.geoapify.com/v1/geocode/reverse?lat=${crd.latitude}&lon=${crd.longitude}&lang=ru&apiKey=261aff77044243bb8c9a545634cea6b3`)
